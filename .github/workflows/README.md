...
| --- | --- | --- |
| **[lotus-build-linux.yml](./lotus-build-linux.yml)** | `lotusd`, `lotus-cli`, `lotus-tx`, `lotus-seeder`, `lotus-wallet` × `linux-amd64` via `depends/` (Qt deferred) | Every run (release **and** dev) |
