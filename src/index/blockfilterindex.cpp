 ...
 *
 * The filters themselves are stored in flat files and referenced by database
 * entries. This minimizes the amount of data written to the database and keeps the
